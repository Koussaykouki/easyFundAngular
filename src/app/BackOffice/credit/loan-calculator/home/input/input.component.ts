...
export class InputComponent {
  ...
  public principalNumMaxValue: number = 50000;
  public principalNumStep: number = 1000;
  ...
  public principalStep: number = 100;
  public principalType: string = 'MinRange';
  public principalTicks: Object = { placement: 'After', largeStep: 10000, smallStep: 100, showSmallTicks: false, format: 'c0' };
  ...
  public yearTenure: boolean = false;
